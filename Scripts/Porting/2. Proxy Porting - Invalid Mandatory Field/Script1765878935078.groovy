...
RequestObject request = findTestObject('Porting/2. Proxy Porting - Invalid Mandatory Field', variable)
...
CustomKeywords.'mii.Porting.compareResponseCode'(bodyResponse, '50051000')
