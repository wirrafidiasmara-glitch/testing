...
RequestObject request = findTestObject('Registration Inquiry by Secondary Id/43. Registration Inquiry by Secondary Id - Failed - Invalid Mandatory Field', 
    variable)
...
CustomKeywords.'mii.ProxyRegInquiry.compareResponseCode'(bodyResponse, '0000')
