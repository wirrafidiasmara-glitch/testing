...
RequestObject request = findTestObject('Network Management/5. Network Management(Echo) (API) - Sukses', variable)
...
CustomKeywords.'mii.Echo.compareResponseCode'(bodyResponse, '20000000')
