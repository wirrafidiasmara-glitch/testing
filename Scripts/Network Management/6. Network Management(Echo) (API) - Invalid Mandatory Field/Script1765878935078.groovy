...
variable.put('functionCode', functionCode)

variable.put('transactionID', transactionID)

variable.put('agentID', agentID)

RequestObject request = findTestObject('Network Management/6. Network Management(Echo) (API) - Invalid Mandatory Field', 
    variable)
...
CustomKeywords.'mii.Echo.compareResponseCode'(bodyResponse, '50051000')
