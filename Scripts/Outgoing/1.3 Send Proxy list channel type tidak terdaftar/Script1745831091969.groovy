...
RequestObject request = findTestObject('Outgoing/1.3 Send Proxy list channel type tidak terdaftar', variable)
...
CustomKeywords.'mii.proxyList.compareResponseCode'(bodyResponse, '2025')
