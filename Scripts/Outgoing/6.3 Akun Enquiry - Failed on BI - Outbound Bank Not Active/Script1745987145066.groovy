...
RequestObject request = findTestObject('Outgoing/6.3 Akun Enquiry - Failed on BI - Outbound Bank Not Active', variable)
...
CustomKeywords.'mii.AccountInquiry.compareResponseCode'(bodyResponse, '3128')
