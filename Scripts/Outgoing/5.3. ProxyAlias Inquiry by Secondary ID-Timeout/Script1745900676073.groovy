...
RequestObject request = findTestObject('Outgoing/5.3. ProxyAlias Inquiry by Secondary ID-Timeout', variable)
...
CustomKeywords.'mii.validation.compareResponseCode'(bodyResponse, '0000')
