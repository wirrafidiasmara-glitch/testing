...
RequestObject request = findTestObject('Outgoing/6.2. Akun Enquiry - Bank Tujuan Sedang Tidak Aktif', variable)
...
CustomKeywords.'mii.AccountInquiry.compareResponseCode'(bodyResponse, '2021')
