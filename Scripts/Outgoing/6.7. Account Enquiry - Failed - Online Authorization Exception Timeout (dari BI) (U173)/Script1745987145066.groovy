...
RequestObject request = findTestObject('Outgoing/6.7. Account Enquiry - Failed - Online Authorization Exception Timeout (dari BI) (U173)', variable)
...
CustomKeywords.'mii.AccountInquiry.compareResponseCode'(bodyResponse, '3173')
