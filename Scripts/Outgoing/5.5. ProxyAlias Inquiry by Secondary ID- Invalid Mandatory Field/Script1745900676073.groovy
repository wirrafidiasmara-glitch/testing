...
RequestObject request = findTestObject('Outgoing/5.5. ProxyAlias Inquiry by Secondary ID- Invalid Mandatory Field', variable)
...
CustomKeywords.'mii.validation.compareResponseCode'(bodyResponse, '3400')
