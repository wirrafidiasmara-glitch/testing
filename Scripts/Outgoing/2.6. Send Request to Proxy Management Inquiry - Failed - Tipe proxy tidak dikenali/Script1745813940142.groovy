...
RequestObject request = findTestObject('Outgoing/2.6. Send Request to Proxy Management Inquiry - Failed - Tipe proxy tidak dikenali', variable)
...
CustomKeywords.'mii.Management_Inquiry.compareResponseCode'(bodyResponse, '2020')
