...
variable.put('otpCode', otpCode)

variable.put('otpMessage', otpMessage)
...
RequestObject request = findTestObject('Outgoing/4.2. Successfully Port a Proxy Alias ID to a New Participant in the Proxy Alias Database Table (PORT)', variable)
