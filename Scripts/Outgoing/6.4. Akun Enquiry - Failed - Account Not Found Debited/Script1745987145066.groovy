...
RequestObject request = findTestObject('Outgoing/6.4 Akun Enquiry - Failed - Account Not Found Debited', variable)
...
CustomKeywords.'mii.AccountInquiry.compareResponseCode'(bodyResponse, '3603')
