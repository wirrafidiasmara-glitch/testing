...
RequestObject request = findTestObject('Outgoing/5.2. Registration Inquiry by Secondary Id - Failed on BI', variable)
...
CustomKeywords.'mii.validation.compareResponseCode'(bodyResponse, '3810')
