...
RequestObject request = findTestObject('Outgoing/2.5. Send Request to Proxy Management Inquiry - Failed - Alias already registered with the same account', variable)
...
CustomKeywords.'mii.Management_Inquiry.compareResponseCode'(bodyResponse, '3808')
