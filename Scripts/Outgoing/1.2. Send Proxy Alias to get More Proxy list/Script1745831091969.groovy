...
RequestObject request = findTestObject('Outgoing/1.2. Send Proxy Alias to get More Proxy list', variable)
...
CustomKeywords.'mii.proxyList.compareResponseCode'(bodyResponse, '0000')
