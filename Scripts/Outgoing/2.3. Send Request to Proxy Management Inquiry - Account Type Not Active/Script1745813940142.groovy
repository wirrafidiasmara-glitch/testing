...
RequestObject request = findTestObject('Outgoing/2.3. Send Request to Proxy Management Inquiry - Account Type Not Active', variable)
...
CustomKeywords.'mii.Management_Inquiry.compareResponseCode'(bodyResponse, '0001')
