...
RequestObject request = findTestObject('Outgoing/6.6. Account Enquiry - Failed - Mandatory Field tidak diisi', variable)
...
CustomKeywords.'mii.AccountInquiry.compareResponseCode'(bodyResponse, '2997')
