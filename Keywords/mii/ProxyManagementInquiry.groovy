...
public class ProxyManagementInquiry {
	...
	def compareResponseCode(def bodyResponse, String message){
		...
		def result = parser['proxyManagementInquiryResponse']['responseCode']
	...
	def compareResponseMessage(def bodyResponse, String message){
		...
		def result = parser['proxyManagementInquiryResponse']['responseMessage']
